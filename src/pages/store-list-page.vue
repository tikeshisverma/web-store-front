...
export default {
 ...
 getUserStoreList(email){
     ...
     return fetch(`http://localhost:3000/api/store?email=${email}`).then(res => res.json())
 }
  }
};
</script>
...
.store-card:hover{
    box-shadow: 0 30px 60px -12px rgba(50,50,93,.1), 0 18px 36px -18px rgba(0,0,0,.1), 0 -12px 36px -8px rgba(0,0,0,.01);
}
.store-card{
    flex: 1;
    color: black;
